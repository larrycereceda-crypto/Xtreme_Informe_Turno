...
const MAESTROS_CACHE_KEY = "informe_capataces_maestros_v22";
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  $("exportFlatBtn").addEventListener("click", exportFlatCsv);
  $("saveHistoryBtn").addEventListener("click", saveToHistory);
  $("clearHistoryBtn").addEventListener("click", clearHistory);
  $("applyFiltersBtn").addEventListener("click", renderConsolidated);
  $("resetFiltersBtn").addEventListener("click", resetConsolidatedFilters);
  $("exportConsolidatedBtn").addEventListener("click", exportConsolidatedCsv);
